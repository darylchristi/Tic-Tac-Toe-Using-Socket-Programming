...
pygame.display.set_caption('[Server] Tic Tac Toe')
...
def waiting_for_connection():
    ...
    print('Click on the cell where you want to place your Symbol')
    print('Press Space Bar to CLEAR GRID')
...
while running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            running = False
        if event.type == pygame.MOUSEBUTTONDOWN and connection_established:  # left mouse click down triggers event X
